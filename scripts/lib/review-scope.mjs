...
const DOMAIN_SPECS = [
  ...
  ["ai_agent_mcp", "security", /prompt|llm|openai|anthropic|mcp|agent|rag|embedding|tool/i, /\b(?:prompt|tool_call|toolUse|mcp|embedding)\b|system message|assistant\s+(?:message|role|response)|role\s*[:=]\s*["']assistant["']/i],

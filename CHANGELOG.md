...
- The mutation-boundary scanner still inspects privileged broker and lifecycle files, so secret and variable writes there cannot skip the direct-write checks.

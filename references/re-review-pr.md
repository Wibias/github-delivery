...
10. Else if clean enough for a re-review-only ask: short review comment (approve only if asked). Do **not** post `[shipping-github] Merge ready` unless the full merge-ready bar was completed.
